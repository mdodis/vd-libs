                    ...
                    for (int entry_index = 0; (entry_index < VD_FW_GAMEPAD_MAX_MAPPINGS) && (gamepad_info->map.mappings[entry_index].kind != VD_FW_GAMEPAD_MAPPING_SOURCE_KIND_NONE); ++entry_index) {
                        ...
                        switch (actual_kind) {
                            ...
                            case VD_FW_GAMEPAD_MAPPING_SOURCE_KIND_AXIS: {
                                int axis_data_index = gamepad_info->axis_data_indices[entry->index];
            ...
            if (wparam == GIDC_ARRIVAL) {
                ...
                if (VdFwHidP_GetValueCaps(VdFwHidP_Input, value_caps, &num_value_caps, new_gamepad->ppd) == VD_FW_HIDP_STATUS_SUCCESS) {
                    ...
                    for (int i = 0; i < num_value_caps; ++i) {
                        ...
                        new_gamepad->axis_data_indices[count++] = value_caps[i].v.NotRange.DataIndex;
                    }
                }
            } else {
...
VdFwGamepadDBEntry Gamepad_Db_Entries[300] = {
    {{0x03,0x00,0x00,0x00,0xfa,0x2d,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x00,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x10,0x38,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x06,0x50,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  8},{0x0001,               VD_FW_GAMEPAD_Y,  9},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x51,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0012,               VD_FW_GAMEPAD_A,  4},{0x0052,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  8},{0x0001,               VD_FW_GAMEPAD_Y,  9},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x20,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x008b,           VD_FW_GAMEPAD_DDOWN,  2},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x15,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x65,0x28,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x35,0x12,0x00,0x00,0x12,0xab,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x02,0x20,0x00,0x00,0x00,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x20,0x38,0x00,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x20,0x38,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x06,0x60,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x00,0x61,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x28,0x00,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x12,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x62,0x28,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x02,0x60,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x02,0x61,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x01,0x60,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x01,0x60,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x01,0x61,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x35,0x12,0x00,0x00,0x20,0xab,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x1b,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  2},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x11,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x13,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x18,0x90,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc8,0x2d,0x00,0x00,0x30,0x32,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa0,0x05,0x00,0x00,0x32,0x32,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x008b,           VD_FW_GAMEPAD_DDOWN,  2},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x05,0x79,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x06,0x79,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xfa,0x19,0x00,0x00,0xf0,0xff,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x36,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x02,0x63,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x11,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x14,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x14,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x19,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x1a,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x1d,0x57,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x49,0x19,0x00,0x00,0x19,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x2a,0x79,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd8,0x1d,0x00,0x00,0x0b,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  5},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT, 12},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  8},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  9},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 13},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0xe5,0x57,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x11,0x00,0x00,0x13,0x52,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  6},{0x0001,               VD_FW_GAMEPAD_B,  7},{0x0001,          VD_FW_GAMEPAD_SELECT,  2},{0x0001,              VD_FW_GAMEPAD_L1,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  1},{0x0001,           VD_FW_GAMEPAD_START,  3},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x32,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbc,0x20,0x00,0x00,0x60,0x12,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbc,0x20,0x00,0x00,0x00,0x55,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbc,0x20,0x00,0x00,0x63,0x12,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbc,0x20,0x00,0x00,0x64,0x12,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x11,0x00,0x00,0x05,0x55,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x11,0x00,0x00,0x06,0x55,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x07,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x80,0x83,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x00,0x55,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x01,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x66,0xf7,0x00,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xe8,0x20,0x00,0x00,0x60,0x58,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x26,0x09,0x00,0x00,0x88,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0003,              VD_FW_GAMEPAD_LT,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x22,0xf6,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0083,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x00c3,              VD_FW_GAMEPAD_RT,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x45,0x13,0x00,0x00,0x08,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x1d,0x00,0x00,0x01,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbd,0x12,0x00,0x00,0x02,0xe0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3,  9},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 10},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x30,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x01,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x0f,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xb8,0x05,0x00,0x00,0x04,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xb8,0x05,0x00,0x00,0x06,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x85,0x21,0x00,0x00,0x02,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x27,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x0d,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x0b,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x22,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x66,0xf7,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x49,0x19,0x00,0x00,0x02,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xac,0x05,0x00,0x00,0x3d,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xac,0x05,0x00,0x00,0x4d,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xac,0x05,0x00,0x00,0x1a,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xff,0xff,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x11,0x00,0x00,0x01,0x40,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x26,0x09,0x00,0x00,0x26,0x25,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0003,              VD_FW_GAMEPAD_LT,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0003,              VD_FW_GAMEPAD_RT,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x28,0x04,0x00,0x00,0x01,0x40,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x5c,0x1a,0x00,0x00,0x33,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  7},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  4},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x83,0x05,0x00,0x00,0x31,0xb0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x45,0x13,0x00,0x00,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x83,0x05,0x00,0x00,0x09,0xa0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xf0,0x25,0x00,0x00,0x21,0xc1,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xf0,0x25,0x00,0x00,0xc3,0x83,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xf0,0x25,0x00,0x00,0xc4,0x83,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xf0,0x25,0x00,0x00,0xc2,0x83,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd1,0x18,0x00,0x00,0x00,0x94,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  6},{0x0001,               VD_FW_GAMEPAD_Y, 12},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  7},{0x0001,             VD_FW_GAMEPAD_DUP, 11},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x63,0x25,0x00,0x00,0x26,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x84,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x85,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x88,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x87,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x6e,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0xee,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  6},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x03,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x49,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd8,0x14,0x00,0x00,0x08,0x62,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  6},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x5f,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x5e,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  6},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x54,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x4d,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x92,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0xc1,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x13,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x24,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xac,0x05,0x00,0x00,0x2c,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  8},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  9},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xb5,0x07,0x00,0x00,0x14,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x49,0x19,0x00,0x00,0x02,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6e,0x05,0x00,0x00,0x05,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6e,0x05,0x00,0x00,0x03,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6e,0x05,0x00,0x00,0x07,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0xd1,0xca,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0xd2,0xca,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0x11,0xc2,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  9},{0x0001,              VD_FW_GAMEPAD_L3,  5},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1, 10},{0x0001,              VD_FW_GAMEPAD_R3,  2},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,               VD_FW_GAMEPAD_X,  4},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0x16,0xc2,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0x18,0xc2,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0x19,0xc2,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6d,0x04,0x00,0x00,0x1a,0xc2,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x80,0x81,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x63,0x82,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc6,0x24,0x00,0x00,0x2a,0x89,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc6,0x24,0x00,0x00,0x2b,0x89,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc6,0x24,0x00,0x00,0x1a,0x89,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc6,0x24,0x00,0x00,0x1b,0x89,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0x66,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x66,0x52,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x50,0x32,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x50,0x82,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x84,0x33,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x84,0x83,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x81,0x34,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  7},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x81,0x84,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  4},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x62,0x52,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x80,0x34,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x80,0x84,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x18,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,               VD_FW_GAMEPAD_Y,  7},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  4},{0x0001,             VD_FW_GAMEPAD_DUP,  6},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x85,0x32,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x38,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x2a,0x06,0x00,0x00,0x10,0x24,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0x01,0x28,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,              VD_FW_GAMEPAD_L1,  0},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  3},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  5},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x10,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0001,              VD_FW_GAMEPAD_R1,  2},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0xe8,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,           VD_FW_GAMEPAD_DDOWN, 13},{0x0001,           VD_FW_GAMEPAD_DLEFT, 12},{0x0001,          VD_FW_GAMEPAD_DRIGHT, 14},{0x0001,             VD_FW_GAMEPAD_DUP, 11},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x00,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xef,0xbe,0x00,0x00,0xed,0xfe,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x01,0x0c,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x08,0x00,0x00,0x01,0xe5,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x15,0x20,0x00,0x00,0x01,0x82,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x55,0x09,0x00,0x00,0x00,0xb4,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0083,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x00c3,              VD_FW_GAMEPAD_RT,  2},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4b,0x12,0x00,0x00,0x01,0x4d,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 11},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 12},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x43,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x44,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xbd,0x12,0x00,0x00,0x15,0xd0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x7e,0x05,0x00,0x00,0x09,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x05,0x00,0x00,0x03,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 12},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START, 10},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x6d,0x57,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x36,0x28,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,           VD_FW_GAMEPAD_DDOWN,  9},{0x0001,           VD_FW_GAMEPAD_DLEFT, 10},{0x0001,          VD_FW_GAMEPAD_DRIGHT, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  8},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  6},{0x0003,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  7},{0x0001,             VD_FW_GAMEPAD_DUP, 13},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,               VD_FW_GAMEPAD_X,  1},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x78,0x23,0x00,0x00,0x0a,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A, 15},{0x0001,               VD_FW_GAMEPAD_B, 14},{0x0001,          VD_FW_GAMEPAD_SELECT,  7},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1, 11},{0x0001,              VD_FW_GAMEPAD_L3,  9},{0x0003,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1, 10},{0x0001,              VD_FW_GAMEPAD_R3,  8},{0x0003,              VD_FW_GAMEPAD_RT,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  6},{0x0001,               VD_FW_GAMEPAD_X, 13},{0x0001,               VD_FW_GAMEPAD_Y, 12},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x01,0xa1,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  6},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  7},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x09,0x12,0x00,0x00,0x07,0x2f,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x00c3,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x00c3,              VD_FW_GAMEPAD_RT,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x12,0x0c,0x00,0x00,0xf6,0x0e,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT, 12},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  5},{0x0001,               VD_FW_GAMEPAD_Y,  7},{0x0001,              VD_FW_GAMEPAD_R1,  4},{0x0001,             VD_FW_GAMEPAD_DUP,  6},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x09,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  5},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x63,0x25,0x00,0x00,0x23,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xe3,0x05,0x00,0x00,0x96,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x08,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x75,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  1},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x08,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  4},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0x88,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x66,0x66,0x00,0x00,0x67,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0001,           VD_FW_GAMEPAD_DDOWN, 14},{0x0001,           VD_FW_GAMEPAD_DLEFT, 15},{0x0001,          VD_FW_GAMEPAD_DRIGHT, 13},{0x0001,             VD_FW_GAMEPAD_DUP, 12},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3,  9},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 10},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x03,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x9d,0x0d,0x00,0x00,0x13,0x30,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x25,0x09,0x00,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  8},{0x0002,           VD_FW_GAMEPAD_DLEFT,  4},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0x68,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x63,0x25,0x00,0x00,0x75,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x88,0x88,0x00,0x00,0x08,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  8},{0x0002,           VD_FW_GAMEPAD_DLEFT,  4},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  9},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 10},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x14,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x07,0x00,0x00,0x56,0xa8,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x00,0x00,0x00,0x82,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0xa0,0x0b,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0xc4,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0xcc,0x09,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0xe6,0x0c,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x26,0x40,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x33,0x40,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x6d,0xca,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x11,0xa7,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x95,0x57,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x9f,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0xc7,0x57,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x22,0x2c,0x00,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START, 10},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x16,0x11,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x12,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x01,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  5},{0x0001,               VD_FW_GAMEPAD_B,  6},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  0},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  3},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  1},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x22,0x2c,0x00,0x00,0x00,0x25,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x22,0x2c,0x00,0x00,0x02,0x23,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x22,0x2c,0x00,0x00,0x00,0x23,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT, 13},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x70,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x22,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x58,0x19,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x18,0x1a,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x1a,0x1a,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0x1c,0x1a,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0xe3,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x05,0x0b,0x00,0x00,0xe5,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0xad,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  4},{0x0001,          VD_FW_GAMEPAD_SELECT, 11},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  3},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0003,              VD_FW_GAMEPAD_RT,  2},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x02,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x01,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x05,0x07,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x07,0x07,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x32,0x15,0x00,0x00,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0093,              VD_FW_GAMEPAD_LV,  2},{0x00d3,              VD_FW_GAMEPAD_LV,  1},{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 12},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x6a,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x6b,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x8a,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x8b,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x5b,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x0d,0x0f,0x00,0x00,0x5c,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  5},{0x0001,          VD_FW_GAMEPAD_SELECT,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0xf1,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  5},{0x0001,          VD_FW_GAMEPAD_SELECT,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,           VD_FW_GAMEPAD_START,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x008b,           VD_FW_GAMEPAD_DDOWN,  4},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  3},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  3},{0x00cb,             VD_FW_GAMEPAD_DUP,  4},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x13,0x0d,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x01,0x0d,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x1e,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x28,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x2f,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x02,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x00c3,              VD_FW_GAMEPAD_LT,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x09,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x1c,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xff,0x11,0x00,0x00,0x31,0x33,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  4},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  5},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x45,0x75,0x00,0x00,0x22,0x11,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x23,0xf6,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x1a,0xf5,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x12,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x0c,0xff,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT, 11},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x0c,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT, 12},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x10,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x0b,0x04,0x00,0x00,0x00,0x01,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x0b,0x04,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x21,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xa3,0x06,0x00,0x00,0x20,0xf6,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x11,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x28,0x9b,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x9b,0x28,0x00,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x8f,0x0e,0x00,0x00,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x11,0x00,0x00,0x05,0x91,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4c,0x05,0x00,0x00,0x68,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B, 16},{0x0001,           VD_FW_GAMEPAD_DDOWN,  6},{0x0001,           VD_FW_GAMEPAD_DLEFT,  7},{0x0001,          VD_FW_GAMEPAD_DRIGHT,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  4},{0x0001,              VD_FW_GAMEPAD_L1, 17},{0x0001,              VD_FW_GAMEPAD_L3,  1},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1, 10},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xde,0x28,0x00,0x00,0xff,0x11,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3,  8},{0x0083,              VD_FW_GAMEPAD_LT,  2},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3,  9},{0x00c3,              VD_FW_GAMEPAD_RT,  2},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x11,0x01,0x00,0x00,0x31,0x14,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x38,0x10,0x00,0x00,0x18,0x14,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 18},{0x0001,           VD_FW_GAMEPAD_DDOWN, 13},{0x0001,           VD_FW_GAMEPAD_DLEFT, 14},{0x0001,          VD_FW_GAMEPAD_DRIGHT, 15},{0x0001,             VD_FW_GAMEPAD_DUP, 12},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x07,0xd0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xfa,0x19,0x00,0x00,0x07,0x06,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xb5,0x07,0x00,0x00,0x12,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  3},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  1},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x0e,0xd0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x15,0xb3,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x23,0xb3,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x04,0xb3,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x00,0xb3,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 11},{0x0001,               VD_FW_GAMEPAD_Y,  5},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  6},{0x0001,              VD_FW_GAMEPAD_R3, 12},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START, 10},{0x0001,               VD_FW_GAMEPAD_X,  1},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x66,0x66,0x00,0x00,0x04,0x88,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x0001,           VD_FW_GAMEPAD_DDOWN, 14},{0x0001,           VD_FW_GAMEPAD_DLEFT, 15},{0x0001,          VD_FW_GAMEPAD_DRIGHT, 13},{0x0001,             VD_FW_GAMEPAD_DUP, 12},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd6,0x20,0x00,0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x5f,0x14,0x00,0x00,0xc5,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xb8,0x05,0x00,0x00,0x02,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd9,0x04,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x30,0x0f,0x00,0x00,0x07,0x01,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x23,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6b,0x14,0x00,0x00,0x02,0x03,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xf0,0x25,0x00,0x00,0xc1,0x83,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xff,0x11,0x00,0x00,0x41,0x33,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  4},{0x0003,              VD_FW_GAMEPAD_RV,  2},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x63,0x25,0x00,0x00,0x23,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x1b,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x03,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x6f,0x0e,0x00,0x00,0x07,0x02,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x45,0x0c,0x00,0x00,0x20,0x43,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x34,0x1a,0x00,0x00,0x06,0x08,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  2},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x17,0x27,0x00,0x00,0x44,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0003,              VD_FW_GAMEPAD_RT,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xc0,0x16,0x00,0x00,0xe1,0x05,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  9},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_R1,  4},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0001,           VD_FW_GAMEPAD_START,  8},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0003,              VD_FW_GAMEPAD_RT,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x79,0x00,0x00,0x00,0x4f,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  0},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT, 10},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 13},{0x0001,               VD_FW_GAMEPAD_Y,  8},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 14},{0x0001,             VD_FW_GAMEPAD_DUP,  9},{0x0003,              VD_FW_GAMEPAD_RH,  3},{0x0003,              VD_FW_GAMEPAD_RV,  4},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x07,0x35,0x00,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0x0001,           VD_FW_GAMEPAD_START, 11},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x12,0x0c,0x00,0x00,0x10,0x1e,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0003,              VD_FW_GAMEPAD_LT,  3},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0003,              VD_FW_GAMEPAD_RT,  4},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd8,0x1d,0x00,0x00,0x0f,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0xd8,0x1d,0x00,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  6},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  7},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x83,0x05,0x00,0x00,0x60,0x20,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  0},{0x0001,          VD_FW_GAMEPAD_SELECT,  6},{0x008b,           VD_FW_GAMEPAD_DDOWN,  1},{0x00cb,           VD_FW_GAMEPAD_DLEFT,  0},{0x008b,          VD_FW_GAMEPAD_DRIGHT,  0},{0x00cb,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,           VD_FW_GAMEPAD_START,  7},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  2},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x4f,0x04,0x00,0x00,0x03,0xd0,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  1},{0x0001,               VD_FW_GAMEPAD_B,  2},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x000b,              VD_FW_GAMEPAD_L1,  3},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  4},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x000b,              VD_FW_GAMEPAD_R1,  4},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  5},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  5},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  0},{0x0001,               VD_FW_GAMEPAD_Y,  3},{0,0,0},
    }},},
    {{0x03,0x00,0x00,0x00,0x10,0x1c,0x00,0x00,0x17,0x1c,0x00,0x00,0x00,0x00,0x00,0x00},
    {{{0x0001,               VD_FW_GAMEPAD_A,  2},{0x0001,               VD_FW_GAMEPAD_B,  1},{0x0001,          VD_FW_GAMEPAD_SELECT,  8},{0x0002,           VD_FW_GAMEPAD_DDOWN,  4},{0x0002,           VD_FW_GAMEPAD_DLEFT,  8},{0x0002,          VD_FW_GAMEPAD_DRIGHT,  2},{0x0002,             VD_FW_GAMEPAD_DUP,  1},{0x0001,              VD_FW_GAMEPAD_L1,  4},{0x0001,              VD_FW_GAMEPAD_L3, 10},{0x0001,               VD_FW_GAMEPAD_Y,  6},{0x0003,              VD_FW_GAMEPAD_LV,  1},{0x0001,              VD_FW_GAMEPAD_R1,  5},{0x0001,              VD_FW_GAMEPAD_R3, 11},{0x0001,             VD_FW_GAMEPAD_DUP,  7},{0x0003,              VD_FW_GAMEPAD_RH,  2},{0x0003,              VD_FW_GAMEPAD_RV,  3},{0x0001,           VD_FW_GAMEPAD_START,  9},{0x0001,               VD_FW_GAMEPAD_X,  3},{0x0001,               VD_FW_GAMEPAD_Y,  0},{0,0,0},
    }},},
};
#endif // VD_FW_GAMEPAD_DB_DEFAULT
